    ...
    <div  class="row">
      ...
      <div id="artlclist" class="col-md-12 col-xs-12">
      	<div class="panel panel-default">
    		...
    		<ul class="list-group">
    							<li class="list-group-item" v-for="list,index in searchlist">
...
export default {
	...
	methods:{
         ...
         list:function(){
			$.post(this.api.api+"/Blog/public/index.php/api/note/search",
            {
         ...
         changepage:function(page){
			$.post(this.api.api+"/Blog/public/index.php/api/Note/pagelist",{page:page,type:'searchlist',typename:this.keyword},res=>{
                for(var i in res){
